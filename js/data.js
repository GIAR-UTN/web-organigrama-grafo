...
export const DATA = {
  ...
  proyectos: [
    {
      ...
      meta: {
        ...
        'Tipo de proyecto': 'UTN PID ??',
        'Código': 'BACCEC748',
        'Programa': 'Electrónica, Computación y Comunicaciones',
    ...
    {
      id:     'INA-2',
      nombre: 'Allium-Cepa-2',
      color:  'var(--c-steel)',
      meta: {
        'Título del proyecto': 'Inteligencia Artificial Aplicada a la Evaluación Ecotoxicológica: Automatización de Ensayo Allium Cepa',
        'Tipo de proyecto': 'UTN PID EC',
        'Código': 'BASIEC848',
        'Programa': 'Electrónica, Computación y Comunicaciones',
        'Tipo de actividad': 'Desarrollo experimental',
  ...
  personas: [
    ...
    },
    {
      ...
      pertenece: [{ id: 'giar', rol: 'Director' }, { id: 'nanosats', rol: 'Director' }, { id: 'EspANLI-UTN', rol: 'Integrante' }],
    },
    {
    ...
    },
    {
      ...
      pertenece: [{ id: 'EspANLI-UTN', rol: 'Director' }, { id: 'Allium-Cepa-2', rol: 'Co-Director' }],
    },
    {
      id: 'p42', nombre: 'Ramiro', apellido: 'Rodríguez Colmeiro',
      rol: 'Electrónica',
      linkedin: null,
      meta: { 'Especialidad': 'Ing. Electrónica', 'Nivel': 'Doctorado', 'Año de incorporación': '2013', },
      pertenece: [{ id: 'Allium-Cepa-2', rol: 'Director' }, { id: 'EspANLI-UTN', rol: 'Co-Director' }],
    },
  ],
};
